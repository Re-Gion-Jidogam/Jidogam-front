...
export default function BannerCard({
  ...
  return (
    <button className="relative flex-1 h-[110px] bg-white rounded-[12px] overflow-hidden shadow-[0_4px_20px_0_rgba(0,0,0,0.08)] cursor-pointer">
      <Image className="absolute right-0 top-0 h-full w-auto" />
